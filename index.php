...
$tbl = "CREATE TABLE IF NOT EXISTS gan_devices ( 
...
$sqls = "INSERT INTO gan_devices (IP,PORT,COMMUNITY) VALUES (\"$x\", \"$y\", \"$z\")";
...
mysqli_select_db($conn,"$database");
    $sqlu = "UPDATE gan_devices SET interfaces='$joined' WHERE IP=\"$r\" AND PORT =\"$t\" AND COMMUNITY=\"$y\"";
